...
<s:layout-render name="/layout.jsp" titlekey="genre.list.title">
    <s:layout-component name="body">
        ...
        <p><f:message key="genre.list.allgenres"/></p>

        <table class="basic">
            <tr>
                <th><f:message key="genre.id"/></th>
            ...
            <c:forEach items="${actionBean.genres}" var="genre">
                <tr>
                    ...
                    <td>
                        <s:link beanclass="com.musiclibrary.euphonyweb.GenreActionBean" event="edit"><s:param name="genre.id" value="${genre.id}"/><f:message key="genre.list.edit"/></s:link>
                        </td>
                        <td>
